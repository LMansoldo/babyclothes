...
import { createNotification, type Notification } from '$lib/domain/notification/entities/Notification'
...
export const mockGrowthRecords: GrowthRecord[] = [
  { id: 'gr-1', childId: 'child-1', weightG: 3200, heightCm: 49, clothingSize: 'RN', recordedAt: new Date('2024-03-15') },
  { id: 'gr-2', childId: 'child-1', weightG: 4500, heightCm: 55, clothingSize: 'P', recordedAt: new Date('2024-05-15') },
  { id: 'gr-3', childId: 'child-1', weightG: 6200, heightCm: 62, clothingSize: 'M', recordedAt: new Date('2024-08-15') },
  { id: 'gr-4', childId: 'child-1', weightG: 7800, heightCm: 68, clothingSize: 'M', recordedAt: new Date('2024-11-15') },
  { id: 'gr-5', childId: 'child-1', weightG: 9100, heightCm: 73, clothingSize: 'G', recordedAt: new Date('2025-03-15') },
  { id: 'gr-6', childId: 'child-2', weightG: 3500, heightCm: 51, clothingSize: 'RN', recordedAt: new Date('2023-08-22') },
  { id: 'gr-7', childId: 'child-2', weightG: 5800, heightCm: 60, clothingSize: 'P', recordedAt: new Date('2023-11-22') },
  { id: 'gr-8', childId: 'child-2', weightG: 8200, heightCm: 70, clothingSize: 'M', recordedAt: new Date('2024-04-22') },
  { id: 'gr-9', childId: 'child-2', weightG: 10500, heightCm: 78, clothingSize: 'G', recordedAt: new Date('2024-08-22') },
  { id: 'gr-10', childId: 'child-2', weightG: 12000, heightCm: 84, clothingSize: 'GG', recordedAt: new Date('2025-02-22') },
  { id: 'gr-11', childId: 'child-3', weightG: 2900, heightCm: 47, clothingSize: 'RN', recordedAt: new Date('2025-01-10') },
  { id: 'gr-12', childId: 'child-3', weightG: 4100, heightCm: 53, clothingSize: 'P', recordedAt: new Date('2025-04-10') },
]
...
export const mockItems: Item[] = [
  {
    ...
    description: 'Lindo macacão floral com laço na cintura. Tecido leve e respirável, perfeito para o verão.',
    category: 'romper',
    gender: 'female',
    clothingSize: 'P',
    condition: 'new',
  ...
  },
  {
    ...
    description: 'Vestido com saia tutu rosa e top de algodão. Ideal para festas e ocasiões especiais.',
    category: 'dress',
    gender: 'female',
    clothingSize: 'G',
    condition: 'new',
...
export const mockMessages: Message[] = [
  {
    id: 'msg-1',
    role: 'agent',
    content: { type: 'text', content: 'Olá! Sou a assistente virtual da BabyClothes. Como posso ajudar você hoje?' },
  ...
  },
  {
    id: 'msg-3',
    role: 'agent',
    content: { type: 'text', content: 'Ótimo! Para 6 meses, geralmente o tamanho M é o mais adequado. Você prefere roupas de que tipo? Macacões, bodies, vestidos?' },
  ...
  },
  {
    id: 'msg-5',
    role: 'agent',
    content: { type: 'text', content: 'Encontrei algumas opções perfeitas para você! Temos o Macacão floral com laço (tamanho P, ideal para 3-6 meses) e o Body manga curta frutas (tamanho P). Ambos são de algodão respirável, perfeitos para o calor.' },
  ...
  },
  {
    id: 'msg-7',
    role: 'agent',
    content: { type: 'text', content: 'O Macacão floral com laço está R$ 89,00. É novo, com etiqueta! A vendedora Maria Souza tem 15 vendas confirmadas e é verificada. Quer que eu mostre mais detalhes?' },
  ...
  },
  {
    id: 'msg-11',
    role: 'agent',
    content: { type: 'text', content: 'Você pode comprar diretamente pelo app! Basta clicar no botão "Comprar" na página do item. Aceitamos PIX, cartão de crédito e boleto. A entrega é feita pelos Correios com rastreamento.' },
